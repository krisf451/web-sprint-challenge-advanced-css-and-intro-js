...
//Use an array method to do this? I just reassigned the name value for that index, not sure if this is wrong
...
function addArtist(arr) {
  arr.push({
    ...
    bio:
      "Just a short sentence about myself. Here is one more sentence about myself."
  });
  return arr;
}
